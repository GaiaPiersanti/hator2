...
$res = $conn->query("SELECT id, name FROM groups ORDER BY name");
...
foreach ($groups as $b) {
    ...
    $editUrl   = "admin.php?page=edit-group&id=$id";
    $deleteUrl = "admin.php?page=delete-group&id=$id";
    ...
    <tr>
      ...
      <td>
        <a href=\"$editUrl\" class=\"btn btn-sm btn-warning btn-icon-split\">
          ...
          <span class=\"text\">Update a group</span>
        </a>
...
$body = new Template("dtml/admin/groups-list");

// invece di setContent("familes", $familes),
// passiamo direttamente l’HTML già pronto:
$body->setContent("groups_rows", $rowsHtml);
