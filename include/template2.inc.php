...
//			$this->buffer = str_replace($searchVal, $replaceVal, $this->buffer);
		...
		if (isset($_SESSION['user'])) {
			...
			$this->setContent("user.first_name", $_SESSION['user']['first_name']);
			$this->setContent("user.last_name", $_SESSION['user']['last_name']);
...
Class Cache{
	...
	var $caching,
		$cache_dir,
		$cache_file,
		$template_file_name, //aggiunta da me per togliere l'errore
		$cache_file_lifetime;
